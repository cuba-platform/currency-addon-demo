package com.company.addon.currency_demo;
...
public class CurrencyaddondemoTestContainer extends TestContainer {

    public CurrencyaddondemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/addon/currency_demo/app.properties",
    ...
    public static class Common extends CurrencyaddondemoTestContainer {

        public static final CurrencyaddondemoTestContainer.Common INSTANCE = new CurrencyaddondemoTestContainer.Common();
